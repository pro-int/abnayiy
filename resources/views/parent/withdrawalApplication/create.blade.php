...
@php
$breadcrumbs = [[['link' => route('parent.withdrawals.index'), 'name' => "الطلبات"],['name'=> 'طلبات الانسحاب']],['title' => 'اضافة طلب انسحاب']];
@endphp
...
{{ Form::open(['route' => 'parent.withdrawals.store','method'=> 'POST' , 'class' => 'row','id' => 'adminform' , 'onsubmit' => 'showLoader()']) }}
...
<script>
    ...
    $("#student_id").select2({
        ajax: {
            url: "/parent/json/search_students",
            method: "post",
            delay: 500,
