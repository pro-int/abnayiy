@props(['title' => 'تأكيد كلمة المرور', 'content' => 'لحماية حسابك .. رجاء ادخال كلمة المرور للأستمرار', 'button' => 'تأكيد'])
    ...
    <x-slot name="content">
      ...
      <div class="mt-2" x-data="{}"
        ...
        <x-jet-input type="password" class="{{ $errors->has('confirmable_password') ? 'is-invalid' : '' }}"
          placeholder="ادخل كلمة المرور" x-ref="confirmable_password" wire:model.defer="confirmablePassword"
