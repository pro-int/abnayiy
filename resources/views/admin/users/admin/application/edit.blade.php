...
@php
$breadcrumbs = [[['link' => route('admins.index'), 'name' => "مديرين النظام"], ['link' => route('ApplicationManagers.index'), 'name' => "مشرفين الطلبات"], [ 'name' => "تعديل مشرف"]],['title' => 'تعديل مشرف']];
@endphp
...
<x-forms.formCard title="تعديل مشرف الطلبات ">
...
{!! Form::model($ApplicationManager, ['method' => 'PUT','route' => ['ApplicationManagers.update', $ApplicationManager->admin_id]]) !!}
    ...
    <x-ui.divider>تعديل قائمة اقسام الأشراف</x-ui-divider>
        ...
        <div class="col-12 text-center mt-2">
            <x-inputs.submit>تعديل مشرف الطلبات </x-inputs.submit>
