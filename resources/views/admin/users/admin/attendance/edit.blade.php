...
@section('title', 'تعديل صلاحيات المشرف')

@php
$breadcrumbs = [[['link' => route('admins.index'), 'name' => "مديرين النظام"], ['link' => route('AttendanceManagers.index'), 'name' => "مشرفين الغياب"], [ 'name' => "تعديل صلاحيات المشرف"]],['title' => 'تسجيل مشرف']];
@endphp
...
<x-forms.formCard title="تعديل صلاحيات المشرف ">
    ...
    <x-ui.divider>اختر احد المديرين </x-ui-divider>
        ...
        <x-ui.divider>الاقسام</x-ui-divider>
            ...
            <div class="col-12 text-center mt-2">
                <x-inputs.submit>تعديل صلاحيات المشرف </x-inputs.submit>
