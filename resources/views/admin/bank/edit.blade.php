...
@php
$breadcrumbs = [[['link' => route('banks.index'), 'name' => "البنوك"]],['title'=> 'تعديل بنك جديد']];
@endphp
...
@component('components.forms.formCard',['title' => sprintf('تعديل معلومات البنك %s', $bank->bank_name)])

{!! Form::model($bank,['route' => ['banks.update',$bank],'method'=>'PUT' , 'onsubmit' => 'showLoader()'])  !!}
...
<x-ui.divider>معلومات البنك</x-ui-divider>
    ...
    <div class="row mb-1">
        ...
        <div class="col-md">
            <x-inputs.text.Input label="اسم الحساب" icon="file-text" name="account_name" placeholder="ادخل اسم الحساب" data-msg="ااسم الحساب بشكل صحيح" />
        </div>
    </div>
    <div class="row mb-1">
        <div class="col-md">
    ...
    <div class="col-12 text-center mt-2">
        <x-inputs.submit >تعديل البنك</x-inputs.submit>
