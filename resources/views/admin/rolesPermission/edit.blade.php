    ...
    <div class="col-12">
      <div class="card">
        <div class="card-header">
          <h4 class="card-title">تعديل  الدور :  {{$role->display_name}} {{ auth()->user()->id }}</h4>
          
        </div>
        <div class="card-body">
        <!-- Add role form -->
        {{ Form::model($role,['route' => ['roles.update',$role->id],'method'=>'PUT','id' => 'addRoleForm', 'class' => 'row','onsubmit' => 'return false']) }}
        <div class="row">
          <div class="col-md">
          ...
          <div class="col-md">
            <x-inputs.select.color label="اللون المميز" name="color" :selected="$role->color" placeholder="ادخل اللون" data-msg="رجاء ادخال اللون المميز للدور" />
          </div>
        </div>
        <div class="col-12">
                ...
                <tr>
                  ...
                  <td>
                    <div class="d-flex">
                      ...
                      <x-inputs.checkbox data-msg="رجاء تحديد صلاحية واحدة علي الاقل" divClass="form-check col-md" name="permission[]" :value="$permission->id" id="permission{{$permission->id}}" :checked="in_array($permission->id, $rolePermissions)">
        ...
        <div class="col-12 text-center mt-2">
          <x-inputs.submit >تحديث</x-inputs.submit>
