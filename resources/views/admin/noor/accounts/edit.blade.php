...
<x-ui.divider>معلومات الحساب</x-ui-divider>
    ...
    <x-ui.divider>تفاصيل دخول نظام نور</x-ui-divider>
        <div class="row mb-1">
            ...
            <div class="col-md">
                <x-inputs.password label="كلمة مرور حساب نور في نظام نور" icon="file-text" name="new_password" placeholder="ادخل كلمة مرور حساب نور في نظام نور" data-msg="اكلمة مرور حساب نور في نظام نور بشكل صحيح" />
            </div>
        </div>

        <div class="col-12 text-center mt-2">
            <x-inputs.submit>تعديل الحساب </x-inputs.submit>
