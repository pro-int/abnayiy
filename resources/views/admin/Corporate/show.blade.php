...
@php
$breadcrumbs = [[['link' => route('corporates.index'), 'name' => "البنوك"]],['title'=> 'مشاهدة معلومات المجمع']];
@endphp

@section('title', 'مشاهدة معلومات المجمع')
...
@component('components.forms.formCard',['title' => sprintf('مشاهدة معلومات المجمع %s', $corporate->corporate_name)])
