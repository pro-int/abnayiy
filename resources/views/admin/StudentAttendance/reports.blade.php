...
<table class="table table-style">
  ...
  <tbody>
    @foreach ($attendance_reports as $key => $report)
    <tr class="table-light">
      <th scope="row">
        {{ $report->id }}
      </th>
      ...
      <td>
        ...
        <a class="btn btn-sm btn-primary" href="{{  route('StudentAttendances.details',['report_id' => $report->id]) }}">تفاصيل الغياب</a>
