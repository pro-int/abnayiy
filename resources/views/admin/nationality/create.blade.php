...
@php
$breadcrumbs = [[['link' => route('nationalities.index'), 'name' => "الجنسيات"], ['link' => route('nationalities.create'), 'name' => "اضافة جنسية جديدة"]],['title'=> 'اضافة']];
@endphp

@section('title', 'اضافة جنسية جديدة')

@section('content')

@component('components.forms.formCard',['title' => 'اضافة جنسية جديدة'])

{!! Form::open(['route' => 'nationalities.store','method'=>'POST' , 'onsubmit' => 'showLoader()'])  !!}
...
<x-ui.divider>معلومات الجنسية</x-ui-divider>
    ...
    <div class="col-12 text-center mt-2">
        <x-inputs.submit>اضافة جنسية جديدة</x-inputs.submit>
