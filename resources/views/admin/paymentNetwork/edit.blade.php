...
@section('title', 'تعديل شبكة جديدة')
...
@component('components.forms.formCard',['title' => sprintf('تعديل معلومات الشبكة : <span class="text-danger">%s</span> ', $PaymentNetwork->network_name)])
...
<x-ui.divider>معلومات الشبكة</x-ui-divider>
    ...
    <div class="col-12 text-center mt-2">
        <x-inputs.submit >تعديل معلومات الشبكة</x-inputs.submit>
