...
@php
$breadcrumbs = [[['link' => route('plans.index'), 'name' => "خطط السداد"], ['link' => route('plans.create'), 'name' => "اضافة خطة سداد"]],['title'=> 'اضافة']];
@endphp


@section('title', 'اضافة خطط السداد')
...
@component('components.forms.formCard',['title' => 'اضافة خطة سداد'])

{!! Form::open(['route' => ['plans.store'],'method'=>'POST' , 'onsubmit' => 'showLoader()']) !!}
...
<x-ui.divider>معلومات خطة السداد</x-ui-divider>
    ...
    <div class="col-12 text-center mt-2">
        <x-inputs.submit>اضافة خطة السداد</x-inputs.submit>
