...
@php
$breadcrumbs = [[['link' => route('plans.index'), 'name' => "خطط السداد"], ['link' => route('plans.show',$plan), 'name' => "مشاهدة خطة السداد"]],['title'=> 'مشاهدة']];
@endphp
...
@component('components.forms.formCard',['title' => sprintf('مشاهدة معلومات خطة السداد : <span class="text-danger"> %s </span>', $plan->plan_name)])
...
<div class="row mb-1">
    ...
    <div class="row mb-1">
        <div class="col-md">
            ...
            <x-inputs.text.Input type="number" icon="calendar" label="موعد استحقاق أول دفعة متكررة" name="payment_due_determination" placeholder="اختر سياسة الدفعة المقدمة اولا .. " />
        </div>
