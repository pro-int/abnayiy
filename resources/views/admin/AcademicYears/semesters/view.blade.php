...
@php
$breadcrumbs = [[['link' => route('home'), 'name' => "الرئيسية"],['link' => route('years.index'), 'name' => "السنوات الدراسية"],['link' => route('years.show',$year->id), 'name' => $year->year_name],['link' => route('years.semesters.index',$year->id), 'name' => 'الفصول الدراسية'],['name'=> 'مشاهدة معلومات فصل دراسي', 'link' => route('years.semesters.edit',[$year->id,$semester->id])] ],['title' => 'مشاهدة معلومات فصل دراسي']];
@endphp

@section('title', 'مشاهدة معلومات فصل دراسي')
...
@component('components.forms.formCard',['title' => 'مشاهدة معلومات الفصل الدراسي '. $semester->semester_name])
...
<x-ui.divider>معلومات الفصل الدراسي</x-ui-divider>
    ...
    <div class="row mb-1">
        <div class="col-md">
            <x-inputs.select.generic :disabled="true" label=" العام الدراسي" name="year_id" placeholder=" اختر العام الدراسي" data-msg="'اختر العام الدراسي بشكل صحيح" :options="App\Models\AcademicYear::years()" />
        </div>
