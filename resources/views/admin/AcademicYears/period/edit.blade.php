...
@section('content')
@component('components.forms.formCard',['title' => "تعديل فترة سداد ($period->period_name) للعام الدراسي : $year->year_name" ])

{!! Form::model($period,['route' => ['years.periods.update',[$year,$period]],'method'=>'PUT' , 'onsubmit' => 'showLoader()'])  !!}
