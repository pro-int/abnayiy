...
@section('title', 'مشاهدة فترة سداد')
...
@section('content')
@component('components.forms.formCard',['title' => "مشاهدة فترة سداد ( $period->period_name ) للعام الدراسي : $year->year_name" ])

{!! Form::model($period,['route' => ['years.periods.store',$year],'method'=>'POST' , 'onsubmit' => 'showLoader()'])  !!}
