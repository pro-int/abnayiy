...
@php
$breadcrumbs = [[['link' => route('years.index'), 'name' => "السنوات الدراسية "],['link' => route('years.show',$year), 'name' => "$year->year_name" ]],['title'=> 'تعديل فترة سداد']];
@endphp

@section('title', 'تعديل فترة طلب انسحاب')
...
@section('content')
@component('components.forms.formCard',['title' => "تعديل فترة طلب انسحاب ($withdrawalPeriod->period_name) للعام الدراسي : $year->year_name" ])

{!! Form::model($withdrawalPeriod,['route' => ['years.withdrawalPeriods.update',[$year,$withdrawalPeriod]],'method'=>'PUT' , 'onsubmit' => 'showLoader()'])  !!}

<x-ui.divider>تفاصيل فترة طلب انسحاب</x-ui-divider>
    <div class="row mb-1">
        <div class="col-md">
    ...
    <div class="col-12 text-center mt-2">
        <x-inputs.submit>تعديل الفترة </x-inputs.submit>
