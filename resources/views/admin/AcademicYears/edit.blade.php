...
<x-ui.divider>معلومات السنة الدراسية</x-ui-divider>
    ...
    <div class="row mb-1">
        ...
        <div class="col-md-4">
            <x-inputs.select.generic :required="false" label="العامل الدرسي السابق" name="previous_year_id" :options="['' => 'لا يوجد'] + App\Models\AcademicYear::years([$year->id])" />
        </div>
    ...
    <div class="row">
        ...
        <div class="col-md">
            <x-inputs.text.Input lang="ar" :value="$year->last_installment_date->format('Y-m')" type="month" label="اقصي موعد للقسط يوم (27) من شهر" name="last_installment_date" placeholder="ادخل اخر قسط في شهر" data-msg="ادخل اخر قسط في شهر بشكل صحيح" />
        </div>

    </div>
    <div class="col-12 text-center mt-2">
        <x-inputs.submit>نعديل معلومات العام الدراسي</x-inputs.submit>
