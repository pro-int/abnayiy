...
@php
$breadcrumbs = [[['link' => route('years.index'), 'name' => "السنوات الدراسية"],['name' => 'تعديل']],['title'=> 'تعديل العام الدراسية']];
@endphp

@section('title', 'اضافة عام دراسي')
...
@component('components.forms.formCard',['title' => 'اضافة عام دراسبي'])

{!! Form::open(['route' => 'years.store','method'=>'POST' , 'onsubmit' => 'showLoader()']) !!}

<x-ui.divider>معلومات العام الدراسي</x-ui-divider>
    ...
    <div class="row mb-1">
        ...
        <div class="col-md-4">
            <x-inputs.select.generic :required="false" label="العامل الدرسي السابق" name="previous_year_id" :options="[null => 'لا يوجد'] + App\Models\AcademicYear::years()" />
        </div>
    ...
    <div class="row">
        ...
        <div class="col-md">
        <x-inputs.text.Input lang="ar" type="month" label="اقصي موعد للقسط يوم (27) من شهر" name="last_installment_date" placeholder="ادخل اخر قسط في شهر" data-msg="ادخل اخر قسط في شهر بشكل صحيح" />
        </div>

    </div>

    <div class="col-12 text-center mt-2">
        <x-inputs.submit>اضافة العام الدراسي</x-inputs.submit>
