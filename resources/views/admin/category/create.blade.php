...
<x-ui.divider>معلومات الفئة</x-ui-divider>
    ...
    <div class="row mb-1">
        <div class="col-3">
            <x-inputs.select.color label="اللون المميز" name="color" placeholder="ادخل اللون" data-msg="رجاء ادخال اللون المميز للفئة" />
        </div>
    ...
    <div class="col-12 text-center mt-2">
        <x-inputs.submit>اضافة فئة جديدة</x-inputs.submit>
