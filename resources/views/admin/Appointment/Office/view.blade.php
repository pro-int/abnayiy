...
@php
$breadcrumbs = [[['link' => route('appointments.sections.index'), 'name' => "اقسام المقابلات"],['link' => route('appointments.offices.index'), 'name' => "مكاتب المقابلات"],['link' => route('appointments.offices.edit',$office), 'name' => "مشاهدة : $office->office_name"]],['title'=> 'مشاهدة معلومات المكتب']];
@endphp

@section('title', sprintf('مشاهدة معلومات المكتب : %s (#%s)', $office->office_name,$office->id))

@section('content')

@component('components.forms.formCard',['title' => sprintf('مشاهدة معلومات المكتب : %s (#%s)',$office->office_name,$office->id)])
