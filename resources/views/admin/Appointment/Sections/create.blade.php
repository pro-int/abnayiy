...
@php
$breadcrumbs = [[['link' => route('appointments.sections.index'), 'name' => "اقسام المقابلات"]],['title'=> 'اضافة قسم جديد']];
@endphp
...
@component('components.forms.formCard',['title' => 'اضافة قسم جديد'])
...
<div class="col-12 text-center mt-2">
    <x-inputs.submit >اضافة القسم</x-inputs.submit>
