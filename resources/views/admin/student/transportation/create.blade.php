...
@component('components.forms.formCard',['title' => sprintf('اضافة حدمة النقل للطالب <span class="text-danger">%s - العقد رقم #%s</span>', $student->student_name, $contract)])
...
<x-ui.divider>معلومات الطالب</x-ui-divider>
    ...
    <div class="col-12 text-center mt-2">
        <x-inputs.submit>اضافة اشتراك النقل</x-inputs.submit>
