...
<x-forms.search route="students.index">
    ...
    <div class="row mb-1">
        <div class="col-md">
            <x-inputs.select.generic :required="false" label="حالة المزامنة" name="noor_status" :options="['' => 'جميع الطلاب' , '0' => 'لام تتم المزامنة' , '1' =>'تم المزامنة']" />
        </div>
        <div class="col-md">
            <x-inputs.select.generic :required="false" label="جنسية الطالب" name="nationality_id" data-placeholder="اختر جنسية الطالب" :options="['' => 'جميع الجنسيات'] + App\Models\nationality::nationalities()" />
        </div>

        <div class="col-md">
            <x-inputs.select.generic :required="false" label="فئة ولي الأمر" name="category_id" data-placeholder="اختر لبفئة" :options="['' => 'جميع الفئات'] + App\Models\Category::categories()" />
        </div>

        <div class="col-md">
            <x-inputs.select.generic :required="false" label="الطلاب بالسنة الدراسية" name="academic_year_id" data-placeholder="الطلاب بالسنة الدراسية" :options="['' => 'جميع الطلاب'] + App\Models\AcademicYear::years()" onchange="toggleSearchInputs()" />
        </div>
    </div>
    ...
    <div id="search-inputs">
        <div class="row mb-1">
            ...
            <div class="col-md">
                <x-inputs.select.generic :required="false" label="حالة التجديد" name="new_contract_status" :options="['' => 'جميع الطلاب'] + getRenewStatus()" />
            </div>
        </div>
