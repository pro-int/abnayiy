...
@php
$breadcrumbs = [[['link' => route('types.index'), 'name' => "المسارات التعليمية "],['link' => route('types.edit',$type), 'name' => "مشاهدة المسار : $type->school_name" ]],['title'=> 'مشاهدة مسار ']];
@endphp
...
{!! Form::model($type, ['method' => 'POST','route' => ['types.update', $type->id]]) !!}
