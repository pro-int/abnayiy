...
@section('content')
@component('components.forms.formCard',['title' => sprintf('تعديل معلومات التصنيف : <span class="text-danger">%s</span>', $classification->classification_name)])
...
<x-ui.divider>معلومات التصنيف</x-ui-divider>
    ...
    <x-ui.divider>اعدادات التصنيف</x-ui-divider>
        ...
        <div class="col-12 text-center mt-2">
            <x-inputs.submit>تعديل معلومات التصنيف </x-inputs.submit>
