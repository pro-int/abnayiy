...
<x-ui.divider>معلومات التصنيف</x-ui-divider>
    ...
    <div class="row mb-1 ">
        ...
        <div class="col-md">
            <x-inputs.text.Input label="بادئة التضنيف" class="only-english" onchange="toUpperCase(this)" icon="tag" name="classification_prefix" placeholder="ادخل بادئة التضنيف" data-msg="رجاء ادخال بادئة التصنيف بشكل صحيح" />
        </div>

        <div class="col-md">
            <x-inputs.select.color label="اللون المميز" name="color_class" placeholder="اختر اللون المميز للتصنيف" data-msg="رجاء اختر اللون المميز " />
        </div>
    </div>
    ...
    <x-ui.divider>اعدادات التصنيف</x-ui-divider>
        ...
        <div class="row mb-1">
            ...
            <div class="col-md">
                <x-inputs.select.generic label="السنة الدراسية" name="academic_year_id" data-placeholder="اختر السنة الدراسية" :options="App\Models\AcademicYear::years()" />
            </div>
        ...
        <div class="col-12 text-center mt-2">
            <x-inputs.submit>اضافة التصنيف </x-inputs.submit>
