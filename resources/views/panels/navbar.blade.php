  ...
  <nav class="header-navbar navbar navbar-expand-lg align-items-center {{ $configData['navbarClass'] }} navbar-light navbar-shadow {{ $configData['navbarColor'] }} {{ $configData['layoutWidth'] === 'boxed' && $configData['verticalMenuNavbarType'] === 'navbar-floating' ? 'container-xxl' : '' }}">
    ...
    <div class="navbar-container d-flex content">
        ...
        <ul class="nav navbar-nav">
          <li class="nav-item d-none d-lg-block">
            <a class="nav-link nav-link-style">
              <em class="ficon" data-feather="{{ $configData['theme'] === 'dark' ? 'sun' : 'moon' }}"></em>
            </a>
          </li>
      ...
      <ul class="nav navbar-nav align-items-center ms-auto">
        ...
        @php $notfication = GetUserNotification() @endphp
        <li class="nav-item dropdown dropdown-notification me-50">
          <a class="nav-link" href="javascript:void(0);" data-bs-toggle="dropdown">
            <em class="ficon" data-feather="bell"></em>
            @if(count($notfication))
            <span class="badge rounded-pill bg-danger badge-up">{{ count($notfication)}}</span>
            @endif
          </a>
          <ul class="dropdown-menu dropdown-menu-media dropdown-menu-end">
            <li class="dropdown-menu-header">
              <div class="dropdown-header d-flex">
                ...
                @if(count($notfication))
                <div class="badge rounded-pill badge-light-primary">{{ count($notfication) }} اشعار جديد</div>
                @endif
              </div>
            </li>
            <li class="scrollable-container media-list">
              @foreach($notfication as $item)
              <a class="d-flex" href="{{  $item->internal_url ?  $item->internal_url : 'javascript:void(0)' }}">
                <div class="list-item d-flex align-items-start">
                  ...
                  <div class="list-item-body position-relative flex-grow-1">
                    <p class="media-heading d-flex"> <span class="fw-bolder">{{ $item->notification_name }}</span>
                      <small class="position-absolute top-0 end-0">{{ $item->created_at->diffforhumans() }}</small>
                    </p>
                    <small class="notification-text"> {{ $item->notification_text }}</small>
                  </div>
                </div>
              </a>
            ...
            <li class="dropdown-menu-footer">
              <a class="btn btn-primary w-100" href="{{ route('MyNotifications') }}">جميع الأشعارات</a>
            </li>
          </ul>
        </li>
        @endif
          ...
          <a class="nav-link dropdown-toggle dropdown-user-link" id="dropdown-user" href="javascript:void(0);" data-bs-toggle="dropdown" aria-haspopup="true">
            <div class="user-nav d-sm-flex d-none">
              ...
              <span class="user-status">
                {{ Auth::user()->admin->job_title ?? 'الأدارة' }}
              </span>
            </div>
            <span class="avatar">
              <img class="round" src="{{ Auth::user() && Storage::exists('Auth::user()->profile_photo_url') ? Auth::user()->profile_photo_url : asset('images/portrait/small/avatar-s-11.jpg') }}" alt="avatar" height="40" width="40">
  ...
  <ul class="main-search-list-defaultlist d-none">
    ...
    <li class="auto-suggestion">
      <a class="d-flex align-items-center justify-content-between w-100" href="{{ url('app/file-manager') }}">
        <div class="d-flex">
          <div class="me-75">
            <img src="{{ asset('images/emcons/xls.png') }}" alt="png" height="32">
          </div>
    ...
    <li class="auto-suggestion">
      <a class="d-flex align-items-center justify-content-between w-100" href="{{ url('app/file-manager') }}">
        <div class="d-flex">
          <div class="me-75">
            <img src="{{ asset('images/emcons/jpg.png') }}" alt="png" height="32">
          </div>
          <div class="search-data">
    ...
    <li class="auto-suggestion">
      <a class="d-flex align-items-center justify-content-between w-100" href="{{ url('app/file-manager') }}">
        <div class="d-flex">
          <div class="me-75">
            <img src="{{ asset('images/emcons/pdf.png') }}" alt="png" height="32">
          </div>
          <div class="search-data">
    ...
    <li class="auto-suggestion">
      <a class="d-flex align-items-center justify-content-between w-100" href="{{ url('app/file-manager') }}">
        <div class="d-flex">
          <div class="me-75">
            <img src="{{ asset('images/emcons/doc.png') }}" alt="png" height="32">
          </div>
          <div class="search-data">
