...
@php
$breadcrumbs = [[['link' => route('contents.index'), 'name' => "محتوي الأشعار"],['link' => route('contents.edit',$content), 'name' => "محتوي الأشعار"]],['title'=> 'تعديل محتوي الأشعار']];
@endphp

@section('title', 'تعديل محتوي الأشعار : ' . $content->content_name)

@section('content')


@component('components.forms.formCard',['title' => sprintf('تعديل معلومات المحتوي : %s', $content->content_name)])

{!! Form::model($content, ['method' => 'PUT','route' => ['contents.update', $content->id ]]) !!}
...
<x-ui.divider>معلومات المحتوي</x-ui-divider>
    ...
    <div class="col-12 text-center mt-2">
        <x-inputs.submit>تعديل المحتوي</x-inputs.submit>
