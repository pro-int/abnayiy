...
<?php
$breadcrumbs = [[['link' => route('schools.index'), 'name' => "المدارس"]],['title'=> 'اضافة مدرسة جديدة']];
?>

<?php $__env->startSection('title', 'اضافة مدرسة جديدة'); ?>
...
<?php $__env->startComponent('components.forms.formCard',['title' => 'اضافة مدرسة جديدة']); ?>

<?php echo Form::open(['route' => 'schools.store','method'=>'POST' , 'onsubmit' => 'showLoader()']); ?>
...
<?php $component = $__env->getContainer()->make(App\View\Components\Inputs\Select\Generic::class, ['label' => 'المجمع الدراسي','name' => 'corporate_id','options' => corporates(1)] + (isset($attributes) ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes([]); ?>اضافة المدرسة <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
    ...
    <?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.contentLayoutMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH I:\wamp64\www\AbnayiyOnVuexsy\resources\views/admin/Corporate/School/create.blade.php ENDPATH**/ ?>