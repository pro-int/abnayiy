...
<?php
$breadcrumbs = [[['link' => route('schools.index'), 'name' => "البنوك"]],['title'=> 'تعديل معلومات المدرسة']];
?>

<?php $__env->startSection('title', 'تعديل معلومات المدرسة'); ?>
...
<?php $__env->startComponent('components.forms.formCard',['title' => sprintf('تعديل معلومات المدرسة %s', $school->school_name)]); ?>
...
<?php echo $__env->make('layouts.contentLayoutMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH I:\wamp64\www\AbnayiyOnVuexsy\resources\views/admin/Corporate/School/edit.blade.php ENDPATH**/ ?>