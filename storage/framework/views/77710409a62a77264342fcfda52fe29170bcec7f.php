    ...
    <div class="col-xl-4 col-md-6 col-12">
      <div class="card card-congratulation-medal">
        <div class="card-body">
          ...
          <img src="<?php echo e(asset('images/illustration/badge.svg')); ?>" class="congratulation-medal" alt="Medal Pic" />
        </div>
      </div>
    </div>
    <!--/ Medal Card -->
                  ...
                  <td>
                    <div class="d-flex align-items-center">
                      <div class="avatar rounded">
                        <div class="avatar-content">
                          <img src="<?php echo e(asset('images/icons/toolbox.svg')); ?>" alt="Toolbar svg" />
                        </div>
                      </div>
                      <div>
                ...
                <tr>
                  <td>
                    <div class="d-flex align-items-center">
                      <div class="avatar rounded">
                        <div class="avatar-content">
                          <img src="<?php echo e(asset('images/icons/parachute.svg')); ?>" alt="Parachute svg" />
                        </div>
                      </div>
                      <div>
                ...
                <tr>
                  <td>
                    <div class="d-flex align-items-center">
                      <div class="avatar rounded">
                        <div class="avatar-content">
                          <img src="<?php echo e(asset('images/icons/brush.svg')); ?>" alt="Brush svg" />
                        </div>
                      </div>
                      <div>
                ...
                <tr>
                  <td>
                    <div class="d-flex align-items-center">
                      <div class="avatar rounded">
                        <div class="avatar-content">
                          <img src="<?php echo e(asset('images/icons/star.svg')); ?>" alt="Star svg" />
                        </div>
                      </div>
                      <div>
                ...
                <tr>
                  <td>
                    <div class="d-flex align-items-center">
                      <div class="avatar rounded">
                        <div class="avatar-content">
                          <img src="<?php echo e(asset('images/icons/book.svg')); ?>" alt="Book svg" />
                        </div>
                      </div>
                      <div>
                ...
                <tr>
                  <td>
                    <div class="d-flex align-items-center">
                      <div class="avatar rounded">
                        <div class="avatar-content">
                          <img src="<?php echo e(asset('images/icons/rocket.svg')); ?>" alt="Rocket svg" />
                        </div>
                      </div>
                      <div>
                ...
                <tr>
                  <td>
                    <div class="d-flex align-items-center">
                      <div class="avatar rounded">
                        <div class="avatar-content">
                          <img src="<?php echo e(asset('images/icons/speaker.svg')); ?>" alt="Speaker svg" />
                        </div>
                      </div>
                      <div>
    ...
    <div class="col-lg-4 col-md-6 col-12">
      <div class="card card-developer-meetup">
        <div class="meetup-img-wrapper rounded-top text-center">
          <img src="<?php echo e(asset('images/illustration/email.svg')); ?>" alt="Meeting Pic" height="170" />
        </div>
        <div class="card-body">
          ...
          <div class="avatar-group">
            ...
            >
              <img src="<?php echo e(asset('images/portrait/small/avatar-s-9.jpg')); ?>" alt="Avatar" width="33" height="33" />
            </div>
            <div
              data-bs-toggle="tooltip"
              data-popup="tooltip-custom"
              ...
              class="avatar pull-up"
            >
              <img src="<?php echo e(asset('images/portrait/small/avatar-s-6.jpg')); ?>" alt="Avatar" width="33" height="33" />
            </div>
            <div
              data-bs-toggle="tooltip"
              data-popup="tooltip-custom"
              ...
              class="avatar pull-up"
            >
              <img src="<?php echo e(asset('images/portrait/small/avatar-s-8.jpg')); ?>" alt="Avatar" width="33" height="33" />
            </div>
            <div
              data-bs-toggle="tooltip"
              data-popup="tooltip-custom"
      ...
      <div class="card card-browser-states">
        ...
        <div class="card-body">
          <div class="browser-states">
            <div class="d-flex">
              <img
                src="<?php echo e(asset('images/icons/google-chrome.png')); ?>"
                class="rounded me-1"
                height="30"
                alt="Google Chrome"
              />
          ...
          <div class="browser-states">
            <div class="d-flex">
              <img
                src="<?php echo e(asset('images/icons/mozila-firefox.png')); ?>"
                class="rounded me-1"
                height="30"
                alt="Mozila Firefox"
              />
          ...
          <div class="browser-states">
            <div class="d-flex">
              <img
                src="<?php echo e(asset('images/icons/apple-safari.png')); ?>"
                class="rounded me-1"
                height="30"
                alt="Apple Safari"
              />
          ...
          <div class="browser-states">
            <div class="d-flex">
              <img
                src="<?php echo e(asset('images/icons/internet-explorer.png')); ?>"
                class="rounded me-1"
                height="30"
          ...
          <div class="browser-states">
            <div class="d-flex">
              <img src="<?php echo e(asset('images/icons/opera.png')); ?>" class="rounded me-1" height="30" alt="Opera Mini" />
...
<?php echo $__env->make('layouts.contentLayoutMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH I:\wamp64\www\AbnayiyOnVuexsy\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>