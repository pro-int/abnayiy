...
class UpdateApplicationRequest extends GeneralRequest
{
    /**
    ...
    public function rules(Request $request)
    {
        ...
        return [
            ...
            'national_id'       => 'required|numeric|'. Rule::unique('applications')->ignore($request->application->id),
            ...
            'level_id'          => 'required',
            'grade_id'          => 'required',
            'selected_date'     => 'required_if:change_appointment,true',
            'selected_time'     => 'required_if:change_appointment,true',
           ...
           'online_url' => 'required_if:online,true',
        ];
    }
