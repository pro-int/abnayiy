...
class StoreAcademicYearRequest extends GeneralRequest
{
    /**
    ...
    public function rules()
    {
        return [
            ...
            'year_numeric' => 'required|numeric|unique:academic_years',
            'year_hijri' => 'required|numeric|unique:academic_years',
            ...
            'is_open_for_admission' => Rule::unique('academic_years')->where('is_open_for_admission',1),
            'current_academic_year' => Rule::unique('academic_years')->where('current_academic_year',1),
            // 'next_year_id' => 'nullable,unique:academic_years',
