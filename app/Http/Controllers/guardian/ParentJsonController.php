...
class ParentJsonController extends Controller
{
    use ManageAppointments;

    public function index(Request $request)
    {
        if (is_callable(ParentJsonController::class . '::' . $request->methodName)) {
            return call_user_func(ParentJsonController::class . '::' . $request->methodName, $request);
        }
    }
